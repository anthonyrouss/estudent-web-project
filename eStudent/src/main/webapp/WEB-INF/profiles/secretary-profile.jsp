...
<%User logged_in_user = (User) session.getAttribute("logged_in_user"); %>
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-secondary mb-1">Γραμματέας</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                     <%= logged_in_user.getLastName() %> <%=logged_in_user.getFirstName() %>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
